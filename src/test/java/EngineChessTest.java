...
class EngineChessTest {
    ...
    void checkCastle() {
        ...
        assertFalse(Tools.hasThisFinalMove(game.getMovesOfPiece(new Position(3, 0)), new Position(5, 0)));
        assertTrue(Tools.hasThisFinalMove(game.getMovesOfPiece(new Position(3, 0)), new Position(1, 0)));
